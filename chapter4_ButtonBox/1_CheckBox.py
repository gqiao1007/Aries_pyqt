...
from PyQt5.QtWidgets import QWidget, QCheckBox, QApplication, QPushButton, QMessageBox, QHBoxLayout, QVBoxLayout
...
class Example(QWidget):
    ...
    def initUI(self):
        ...
        HBV = QVBoxLayout()
        HBV.addWidget(self.cb1)
        HBV.addWidget(self.cb2)
        HBV.addWidget(self.cb3)
        HBV.addWidget(self.cb4)
